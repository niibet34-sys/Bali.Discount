...
document.addEventListener('click',e=>{const a=e.target?.closest?.('a[href]');if(!a||a.id==='bali-en-whatsapp')return;const local=localizeNotionHref(a.href);if(!local)return;e.preventDefault();e.stopPropagation();location.assign(local)},true);
