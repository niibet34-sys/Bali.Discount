...
export default {
  async fetch(request, env, ctx) {
    ...
    return new HTMLRewriter()
      .on(".bali-ru-wa img", new WhatsAppIconRewriter())
      .transform(response);
  },
};

class WhatsAppIconRewriter {
  element(element) {
