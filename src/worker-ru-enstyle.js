...
#bali-ru-toggle{width:58px;height:58px;border:0;border-radius:50%;background:#25D366;color:#fff;display:grid;place-items:center;box-shadow:0 14px 34px rgba(0,0,0,.25);cursor:pointer;padding:0}#bali-ru-toggle .bali-ru-open{width:58px;height:58px;display:grid;place-items:center;line-height:0}#bali-ru-toggle .bali-ru-open svg{display:block;width:68%;height:68%;fill:currentColor}.bali-ru-close{display:none;font-size:32px;line-height:1}#bali-ru-contact.open .bali-ru-open{display:none}#bali-ru-contact.open .bali-ru-close{display:block}
</style>`, { html: true });
  }
}
